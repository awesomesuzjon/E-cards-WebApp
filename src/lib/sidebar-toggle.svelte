<script>
	...
	import { removeImgFunc } from './removeImg.svelte';
	import FontFamily from './fontFamily.svelte';
	import Resize from '../routes/resize.svelte';
...
<div class="flex justify-between items-center">
	<div class="drawer w-1/3">
      ...
      <!-- <li class="p-4">
          ...
          class="border-2 text-black border-gray-500 w-3/6 h-8 mt-2 text-sm font-bold dark:text-gray-800"
          /> 
           -->
           <li class="p-4">
