...
>
	...
	<div class="flex flex-col  gap-2 ">
		<progress class="progress progress-error w-86" value="10" max="100" />
		<progress class="progress progress-error w-86" value="40" max="100" />
		<progress class="progress progress-error w-86" value="70" max="100" />
		<progress class="progress progress-error w-86" value="100" max="100" />
	</div>
</div>
