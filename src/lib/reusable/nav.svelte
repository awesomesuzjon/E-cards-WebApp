<script>
	...
	import IoMdMailUnread from 'svelte-icons/io/IoMdMailUnread.svelte';
...
<div
	class="bg-red-700  dark:bg-customColorGray    text-white justify-between flex px-8  h-16  items-center "
>
	<div>
		<a href="/"><img src="logo.png" alt="HamroPatro Logo" class="w-16 mt-6 ml-6 " /></a>
	</div>

	<div class="flex justify-around text-sm ">
		<p class="dark:text-white">Path:{$page.url.pathname}</p>
	</div>

	<div class="flex flex-row items-center ">
		<div class="flex justify-center">
			<div class=" xl:w-96">
				<div class="input-group relative flex  items-center w-full  rounded">
					<input
						type="search"
					...
					/>
					<h2 class="w-4  mx-2 "><FaSearch /></h2>
				</div>
			</div>
		</div>

		<h2 class="w-5 mx-2 "><IoIosNotifications /></h2>
		<h2 class="w-5  mx-2 "><IoMdMailUnread /></h2>
		<div class="flex-row flex items-center p-2">
