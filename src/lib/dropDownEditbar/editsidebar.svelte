...
<div class="drawer invisible bg-gray-800 drawer-end w-1/3" id="editPanelDiv">
	<div
		class="
   drawer-side w-full h-screen overflow-hidden"
	>
		<ul class="divide-y-2  text-sm text-white">
